...
image: https://github.com/blankshiro/blankshiro.github.io/blob/main/assets/img/image_previews/htb-blue.png?raw=true
---
...
Thereafter, we need to adjust the following part of the source code of `42315.py`:
